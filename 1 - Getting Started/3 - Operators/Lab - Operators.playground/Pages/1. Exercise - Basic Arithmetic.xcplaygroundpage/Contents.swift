...
//We divide two constants of type double and get a result of type double as well
//And in the previous case, we divided two constants of type integer and got a result of the same type. So the remainder was discarded
/*:
...
print(even % 2)
print(odd % 2)
//An odd number when divided by 2 will have a remainder of 1, an even number will have a remainder of 0
/*:
