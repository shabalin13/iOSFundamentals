...
func getLoggedFood(mealTime: String) -> Meal? {
    return meals[mealTime]
}

print(getLoggedFood(mealTime: "Breakfast"))
print(getLoggedFood(mealTime: "Lunch"))
print(getLoggedFood(mealTime: "Dinner"))
/*:
