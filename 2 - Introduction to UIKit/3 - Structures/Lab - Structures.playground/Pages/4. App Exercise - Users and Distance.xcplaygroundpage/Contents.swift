...
var dima = User(name: "Dima", age: 20, height: 180, weight: 90, activityLevel: 7)
print("I'm \(dima.name), \(dima.age). My height is \(dima.height) cm and weight is \(dima.weight) kg. I have an activity level of \(dima.activityLevel)")
/*:
...
var distance = Distance(feet: 589)
