...
var favoriteBook = Book(title: "Harry Potter", author: "Joanne Rowling", pages: 678, price: 100)
print("\"\(favoriteBook.title)\" by \(favoriteBook.author) has \(favoriteBook.pages) pages and costs \(favoriteBook.price) dollars")
/*:
...
var laptop1 = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2021)
