...
struct User {
    ...
    static var currentUser = User(userName: "shabalin13", email: "d.shabalin@innopolis.university", age: 20)
 ...
 */
User.logIn(user: User(userName: "evgeny", email: "evgeny@gmail.com", age: 21))
print(User.currentUser.userName)
print(User.currentUser.email)
print(User.currentUser.age)
/*:
